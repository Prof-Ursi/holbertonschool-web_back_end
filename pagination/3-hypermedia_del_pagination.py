...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        ...
        Description:
        ------------
            Takes two arguments and returns a dictionary containing hypermedia
            information about the dataset based on the specified index
            and pagination parameters.

        Args:
        -----
        index (int):
            Current index of the return page, default is None.
        page_size (int):
        ...
        --------
        (dict):
            Hypermedia information including index, next_index,
            page_size and data.
        """
